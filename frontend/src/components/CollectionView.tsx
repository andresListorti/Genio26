  ...
  return (
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-16 sm:py-20 lg:py-24">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-14">
        <div>
          <p className="eyebrow">{q ? `Resultados para "${q}"` : eyebrow}</p>
          <h1 className="heading-display text-3xl sm:text-4xl md:text-5xl mt-3">
            {q
        ...
        <div className="py-20 text-center">
          ...
          <p className="text-muted text-sm">
            {q
              ...
              : "No hay productos disponibles en esta colección. Asegurate de que la API esté corriendo."}
          </p>
        </div>
      ) : (
