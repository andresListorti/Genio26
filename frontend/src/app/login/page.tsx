...
function getErrorMessage(error: unknown): string {
  ...
  if (msg.includes("too-many-requests")) return "Demasiados intentos. Intentá más tarde.";
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-16">
        ...
        <h1 className="heading-display text-3xl mb-2">Bienvenido</h1>
        <p className="text-sm text-muted mb-10">Iniciá sesión para continuar.</p>
